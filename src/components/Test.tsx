...
import banshawali from "@/components/lottie/test2.json";
  ...
  return (
    <div className=" min-h-screen">
      <div
        className={` ${
          isSmallScreen
            ? "h-96 w-96 bg-red-400"
            : " h-screen w-screen bg-green-400"
        }`}
      ></div>
      <div>
        <Lottie
          animationData={banshawali}
          className=" bg-green-300  w-[600px] h-[600px] rounded-full "
        />
      </div>
